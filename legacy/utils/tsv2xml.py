...
storylist = pd.read_csv('storylist.tsv', delimiter='\t')
...
def GenerateStoryHeader(row):
    ...
    editor1 = root.createElement('editor')
    editor1.appendChild(root.createTextNode(row['editor1']))
    editor2 = root.createElement('editor')
    editor2.appendChild(root.createTextNode(row['editor2']))
    titleStmt.appendChild(title)
    titleStmt.appendChild(author)
    titleStmt.appendChild(editor1)
    titleStmt.appendChild(editor2)
    ...
    nodeP.appendChild(root.createTextNode('Stories'))
